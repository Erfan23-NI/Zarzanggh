...
import time
import requests
from flask import Flask, Response  # اضافه شده برای حل مشکل پورت
...
# تنظیمات اصلی - دریافت از متغیرهای محیطی
TOKEN = os.environ.get('TOKEN', 'YOUR_BOT_TOKEN')
ADMIN_CHAT_ID = int(os.environ.get('ADMIN_CHAT_ID', 86101721))
DB_NAME = "bot_data.db"
PORT = int(os.environ.get('PORT', 10000))  # پورت از محیط دریافت می‌شود

# ======================================================================
# ==================== قابلیت بیدار ماندن ربات =========================
# ======================================================================
PING_URL = f"https://{os.environ.get('RENDER_EXTERNAL_HOSTNAME', 'your-app-name.onrender.com')}"  # آدرس خودکار
